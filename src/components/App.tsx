...
> {
  ...
  private handleClearSessionClick = () => {
    ...
    if (
      window.confirm('Do you really want to remove all notes from the session?')
    ) {
  ...
  private saveSharedSessionToMySessions = async () => {
    ...
    notificationsStore.showNotification({
      message: `Saved "${originalSession.name}" in your sessions as "${sessionName}"`,
      level: 'success',
      autohide: 6000,
    })
  }
      ...
      <>
        ...
        <Flex flex={1} justifyContent="center">
          <Flex maxWidth={MaxLayoutWidth} width={1} alignItems="center">
            ...
            {isSignedIn && sessionStore.activeSessionType === 'shared' && (
              <Button
                m={[1, 2]}
                bg="#f50057"
